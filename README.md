...
Lurtz is a chat bot built on the Hubot framework.
...
Then you can interact with Lurtz by typing `Lurtz help`.
    ...
    lurtz> lurtz help
    lurtz animate me <query> - The same thing as `image me`, except adds [snip]
    lurtz help - Displays all of the help commands that Lurtz knows about.
    ...
